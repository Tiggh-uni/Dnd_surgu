document.addEventListener('DOMContentLoaded', function() {
    ...
    const navHtml = `
        <nav style="background: #f0e4c2; padding: 1rem 2rem; border-bottom: 1px solid #e0cfbc; display: flex; gap: 1.5rem; flex-wrap: wrap;">
            <a href="${pathToRoot}index.html" style="color: #6b3f1c; text-decoration: none; font-weight: bold;">🏠 Главная</a>
            <a href="${pathToRoot}generators/quests.html" style="color: #6b3f1c; text-decoration: none;">🎲 Генератор квестов</a>
